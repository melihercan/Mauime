...
`UseMauimeNfc` registers `INfc` as a singleton and wires up the platform plumbing — on Android that
...
dependency in the public API of everything that used it; `Mauime.Nfc` has no third-party
