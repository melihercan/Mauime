...
namespace Me.Toolkit.Maui.Hosting;
...
/// </para>
/// </remarks>
public static class MeToolkitMauiHostingExtensions
{
    /// <summary>
    /// The configuration key <see cref="UseMeToolkitMauiHostingFromConfiguration"/> reads by default.
    ...
    public static MauiAppBuilder UseMeToolkitMauiHosting(this MauiAppBuilder builder, string environmentName)
    {
    ...
    /// </remarks>
    public static MauiAppBuilder UseMeToolkitMauiHostingFromConfiguration(
        ...
        Func<IServiceProvider, string?> environmentName)
    {
        ...
        builder.Services.AddSingleton<IHostEnvironment>(services =>
        {
            ...
            return new MeToolkitMauiHostEnvironment(inner, name);
        });
    ...
    /// </remarks>
    private sealed class MeToolkitMauiHostEnvironment(IHostEnvironment? inner, string? environmentName) : IHostEnvironment
    {
